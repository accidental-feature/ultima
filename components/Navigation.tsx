	...
	return (
		<>
			...
			<div className="shadow-md">
				<nav className="container relative lg:mx-auto px-2 max-w-4xl py-3 mb-3" id="navbar">
					<div className="lg:inline-flex flex items-center justify-between mx-3 py-2 text-cloud-kh">
						<Link href='/' className="font-semibold text-xl">Ultima rest</Link>
					...
					<ul className={`${hidden && 'hidden'} mx-3 inline-flex flex-col lg:flex-row lg:mx-0 lg:inline-flex lg:float-right`}>
						<li className="mt-1.5">
							<Link 
						...
						<li className="mt-1.5">
							<a 
								className="no-underline px-3 py-2 flex 
									items-center text-sm font-bold leading-snug 
									cursor-pointer hover:opacity-75" 
								href='https://github.com/0hundred0'
							>
						...
						<li className="mt-1.5">
							<a
								className="no-underline px-3 py-2 flex 
									items-center text-sm font-bold leading-snug 
									cursor-pointer hover:opacity-75"  
							href='https://discord.gg/Qs7qJY3z'>
